...
@Service
@Transactional
public class FrameRoleresourceServiceImpl extends AbstractService<FrameRoleresource> implements FrameRoleresourceService {
    // 需要手工追加查询逻辑才添加
    //Resource
    //private FrameRoleresourceMapper frameRoleresourceMapper;
