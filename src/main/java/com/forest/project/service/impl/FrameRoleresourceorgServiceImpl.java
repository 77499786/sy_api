...
@Service
@Transactional
public class FrameRoleresourceorgServiceImpl extends AbstractService<FrameRoleresourceorg> implements FrameRoleresourceorgService {
    // 需要手工追加查询逻辑才添加
    //Resource
    //private FrameRoleresourceorgMapper frameRoleresourceorgMapper;
